...
const main = async () => {
    ...
    // 2. Generar claves criptográficas para BabyJubJub
    console.log("🔑 Generando claves criptográficas...");
    
    // Para BabyJubJub, necesitamos claves específicas
    // Estos valores son de ejemplo y necesitarían ser generados correctamente
    ...
    // Registration hash simplificado
    ...
    const inputs = {
        privateInputs: [
            "1234567890123456789012345678901234567890123456789012345678901234", // Private key (ejemplo)
        ],
        publicInputs: [
    ...
    try {
        ...
        const proof = {
            ...
            publicSignals: [
                publicKeyPoint.x.toString(),
                publicKeyPoint.y.toString(),
                address,
                chainId.toString(),
                registrationHash
