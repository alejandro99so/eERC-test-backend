...
func Mint(pp helpers.TestingParams) {
	// Read the input file
	...
	f := func() frontend.Circuit { return &circuits.MintCircuit{} }
	...
	if pp.Extract {
		helpers.SaveCS(ccs, "MINT")
		helpers.SavePK(pk, "MINT")
		helpers.SaveVK(vk, "MINT")
	}
}
